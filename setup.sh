...
start_subtask "Install emacs-plus@30"
brew install emacs-plus@30 --with-imagemagick --with-modern-doom3-icon >/dev/null 2>&1
end_subtask "Install emacs-plus@30" true